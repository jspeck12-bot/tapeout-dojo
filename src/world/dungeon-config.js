const DUNGEON_CFG = {
  ...
  3: {
    ...
    theme: { bg: 0x090607, fog: 0.025, floorCol: 0x15191d, gridCol: 0x244b5c, wallCol: 0x273139, accent: 0xff7b38, ambient: 0.58, ceil: true, prop: 'pipe' },
  ...
  5: {
    ...
    theme: { bg: 0x04070d, fog: 0.024, floorCol: 0x121318, gridCol: 0x5b4925, wallCol: 0x2d2b29, accent: 0xd9a441, ambient: 0.52, ceil: true, prop: 'gear' },
  ...
  6: {
    ...
    theme: { bg: 0x070509, fog: 0.027, floorCol: 0x151417, gridCol: 0x513846, wallCol: 0x343238, accent: 0xfb7185, ambient: 0.48, ceil: true, prop: 'crenel' },
  ...
  7: {
    ...
    theme: { bg: 0x030506, fog: 0.015, floorCol: 0x101519, gridCol: 0x746323, wallCol: 0x353e44, accent: 0xfacc15, ambient: 0.42, ceil: true, prop: 'altar' },
