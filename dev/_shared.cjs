...
const EXPORTS = [
  ...
  'netlistOf', 'COMBAT_PROTO_ID', 'PROTO_ATTACKS', 'ATK_TELL',
  'gateCountOf', 'gateMultOf', 'combatDamageOf', 'combatTune', 'staggerAfter',
  'hexViolates', 'clockStormFails', 'combatKitFor', 'makeVolley', 'pickHexKind',
];
